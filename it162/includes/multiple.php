...
<div>	
    <label>
        ...
        <select name="How_Did_You_Hear_About_Us?" required="required" title="How You Heard is required" tabindex="30">
            ...
            <option value="Phone">Search Engine</option>
            <option value="Web">Social Media</option>
            <option value="Magazine">Print Media</option>
...
<div>	
    <fieldset>
        ...
        <input type="checkbox" name="Interested_In[]" value="Lollipops" /> A Hug <br />
